...
const PlayerMenu = (props) => {
  ...
  return (
    <div className=" w-[400px] bg-[#1f416b]  text-center text- rounded-xl drop-shadow-lg fontkeliye ">
      ...
      <div className="flex flex-row justify-evenly  -translate-x-5 text-white font-semibold">
        ...
        <label 
        onClick={labelClickHandler}  htmlFor="2"
        className={`cursor-pointer    mt-6 w-1/5 aspect-square p-4 text-4xl  bg-opacity-5  
        LabelSelected==htmlFor? bg-white : bg-black `}  >2</label>
        <input 
        onChange={changeHandler} 
        className="hidden" 
        type="radio" 
        ...
        name="playerCount" /> 
        <label
        onClick={labelClickHandler}  htmlFor="3"
        className={`cursor-pointer    mt-6 w-1/5 aspect-square p-4 text-4xl  bg-opacity-5  
        LabelSelected==htmlFor? bg-white : bg-black `}>3</label>
        <input 
        onChange={changeHandler} 
        className="hidden" 
        type="radio" 
        ...
        name="playerCount" /> 
        <label  
        onClick={labelClickHandler}  htmlFor="4"
